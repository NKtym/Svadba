...
export default function AdminPage() {
  ...
  if (!authed) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50">
        <div className="relative rounded-2xl max-w-sm w-full overflow-hidden">
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-amber-50 via-rose-50 to-purple-50">
